#' GBCC default R markdown format
#'
#' Template for creating an R markdown document in GBCC style
#'
...
default <- function(toc = FALSE, toc_depth = 3, number_sections = FALSE,
  ...
  css <- c(css, list.files(system.file("rmarkdown", "templates", "gbccdefault", "resources",
                                       package = "gbccmarkdown"),
                           "*.css$", full.names=TRUE))

  header <- system.file("rmarkdown", "templates", "gbccdefault", "header.html",
                        package = "gbccmarkdown")
  ...
  if (identical(template, "default"))
    args <- c(args, "--template",
              rmarkdown::pandoc_path_arg(system.file("rmarkdown", "templates", "gbccdefault", "base.html",
                                                     package = "gbccmarkdown")))
